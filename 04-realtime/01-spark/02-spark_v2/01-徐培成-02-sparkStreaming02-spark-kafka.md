 ...
 **/
public class A0902_Stream_kafka_java {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaStreamingContext streamingContext = new JavaStreamingContext(javaSparkContext, Seconds.apply(10));


        //03, 配置kafka的参数
        Map<String, Object> kafkaParams = new HashMap<>();
        kafkaParams.put("bootstrap.servers", "centos01:9092,centos02:9092,centos03:9092");
        //这里代表key或者value接受的消息是字符串格式，默认是自己字节数组
        ...
        Collection<String> topics = Arrays.asList("spark01");
