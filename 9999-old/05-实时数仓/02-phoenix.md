```shell
create table test.user_state(user_id varchar primary key, state.if_consumed varchar) salt_buckets = 3;
...
https://blog.csdn.net/duguyiren3476/article/details/84710728
...
```sql
-- phoenix 联合主键
create table if not exists learn.us_population(state char(2) not null, city varchar not null, population bigint constraint my_pk primary key (state, city));
